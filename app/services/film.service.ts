...
export class FilmService {
    ...
    searchUrlFirstPart: string =
    'https://api.themoviedb.org/3/search/movie?api_key=4f6a92e0a096ef372e94f1dfb9403a29&language=ru&query=';
    searchUrlSecondPart: string = '&page=';
    ...
    private extractSearchListData(res: Response) { 
        let body = res.json();
        return body || {};
    }

    private extractItemData(res: Response) {
        let film: Film = res.json();
        return film || {};
    }
