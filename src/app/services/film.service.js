...
var FilmService = (function () {
    function FilmService(http) {
        ...
        this.searchUrlFirstPart = 'https://api.themoviedb.org/3/search/movie?api_key=4f6a92e0a096ef372e94f1dfb9403a29&language=ru&query=';
    ...
    FilmService.prototype.extractSearchListData = function (res) {
        var body = res.json();
        return body || {};
    };
