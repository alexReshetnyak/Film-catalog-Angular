...
/* harmony import */ var _reuse_strategy__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./reuse-strategy */ "./src/app/reuse-strategy.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                },
                {
                    ...
                    useClass: _reuse_strategy__WEBPACK_IMPORTED_MODULE_10__["CustomReuseStrategy"]
                }
                // FilmService
            ],
...
var CustomReuseStrategy = /** @class */ (function () {
    ...
    CustomReuseStrategy.prototype.shouldAttach = function (route) {
        var canAttach = !!route.routeConfig &&
...
var FilmService = /** @class */ (function () {
    ...
    FilmService.prototype.getActors = function (filmId) {
        return this.http.get(this.actorsUrlFirstPart + filmId + this.actorsUrlSecondPart)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (answer) { return console.log(answer, 'answer'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (answer) { return answer.cast; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    /*-------------------------BACKEND----------------------------------------------*/
